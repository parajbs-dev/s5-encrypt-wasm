...
const { readFile, getEncryptedStreamReader, calculateB3hashFromFile, calculateB3hashFromFileEncrypt, removeKeyFromEncryptedCid, combineKeytoEncryptedCid, createEncryptedCid, encryptFile, getTransformerEncrypt, } = require("./utils/encryptWasm-nodejs");
// Main exports.
module.exports = {
    generate_key,
