...
exports.initSync = exports.generate_key = exports.encrypt_file_xchacha20 = void 0;
let wasm;
...
* @returns {Uint8Array}
*/
function encrypt_file_xchacha20(input_file, key, padding, chunk_index) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(input_file, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.encrypt_file_xchacha20(retptr, ptr0, len0, ptr1, len1, padding, !isLikeNone(chunk_index), isLikeNone(chunk_index) ? 0 : chunk_index);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('encrypt_file_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
